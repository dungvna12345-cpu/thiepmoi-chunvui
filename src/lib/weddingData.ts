  ...
  events: [
    {
      ...
      address: 'Số nhà 77, thôn Yên Phú, xã Ngọc Hồi, TP. Hà Nội',
      mapsUrl: 'https://maps.google.com/?q=Số+nhà+77+thôn+Yên+Phú+Ngọc+Hồi+Hà+Nội',
      calendarUrl: 'https://calendar.google.com/calendar/render?action=TEMPLATE&text=Bữa+Cơm+Thân+Mật+Nhà+Trai+-+Thành+Nhớ+%26+Phạm+Ngân&dates=20260928T100000Z/20260928T130000Z&details=Bữa+Cơm+Thân+Mật+Nhà+Trai&location=Thôn+Yên+Phú+Ngọc+Hồi+Hà+Nội',
    },
    {
      id: 'thanh-hon',
      ...
      address: 'Số nhà 77, thôn Yên Phú, xã Ngọc Hồi, TP. Hà Nội',
      mapsUrl: 'https://maps.google.com/?q=Số+nhà+77+thôn+Yên+Phú+Ngọc+Hồi+Hà+Nội',
      calendarUrl: 'https://calendar.google.com/calendar/render?action=TEMPLATE&text=Lễ+Thành+Hôn+-+Thành+Nhớ+%26+Phạm+Ngân&dates=20260929T070000Z/20260929T100000Z&details=Lễ+Thành+Hôn+tại+Tư+gia+Nhà+Trai&location=Thôn+Yên+Phú+Ngọc+Hồi+Hà+Nội',
    },
    {
      id: 'vu-quy',
