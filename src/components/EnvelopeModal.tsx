  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ========================================================================= */}
        {/* 2. WEDDING CARD & ENVELOPE STAGE                                         */}
        {/* ========================================================================= */}
        <div
          onClick={handleOpenEnvelope}
          className="relative w-[300px] sm:w-[345px] h-[360px] sm:h-[400px] cursor-pointer group my-1 select-none"
        >
          {/* A. HOA HỒNG ĐỎ TRÁI (LEFT BOTANICAL ROSE SPRIG) */}
          <div className="absolute top-10 -left-6 sm:-left-8 w-28 sm:w-34 h-38 sm:h-46 pointer-events-none z-10 transition-transform duration-500 group-hover:-translate-y-1 drop-shadow-xl">
            <Image
              src="/images/decor/red_rose_branch_decor.webp"
              alt="Red Rose Branch"
              fill
              sizes="160px"
              className="object-contain filter brightness-[0.98]"
              priority
            />
          </div>

          {/* B. BÓ HOA CƯỚI PHẢI (BOTTOM-RIGHT WEDDING BOUQUET) */}
          <div className="absolute -bottom-4 -right-5 sm:-right-7 w-28 sm:w-34 h-34 sm:h-42 pointer-events-none z-40 transition-transform duration-500 group-hover:scale-105 drop-shadow-2xl">
            <Image
          ...
          <div
            className="absolute left-1/2 -translate-x-1/2 bottom-[140px] sm:bottom-[160px] w-[265px] sm:w-[305px] h-[95px] sm:h-[110px] bg-gradient-to-t from-[#8F1724] to-[#55111B] border-t border-l border-r border-[#D8B45F]/60 rounded-t-2xl z-0 pointer-events-none overflow-hidden"
            style={{
          ...
          {/* ======================================================================= */}
          {/* D. IVORY WEDDING CARD (TẤM THIỆP CƯỚI IVORY THẲNG ĐỨNG SANG TRỌNG)       */}
          {/* ======================================================================= */}
          <div
            className={`absolute left-1/2 -translate-x-1/2 top-1 w-[225px] sm:w-[258px] bg-[#FFF9ED] p-2.5 sm:p-3 rounded-2xl shadow-[0_16px_45px_rgba(0,0,0,0.55)] border border-[#D8B45F]/60 transition-all duration-700 ease-out z-15 ${
              isOpening
                ? '-translate-y-16 scale-105 shadow-2xl'
                : 'group-hover:-translate-y-2'
            }`}
          >
            {/* 1. KHUNG ẢNH LỄ ĐƯỜNG / BẢO TÀNG: CHIẾM 65% CARD, HIỂN THỊ TRỌN VẸN CÔ DÂU CHÚ RỂ VÀ KIẾN TRÚC */}
            <div className="relative w-full aspect-[4/4.6] rounded-xl overflow-hidden bg-stone-100 border border-[#D8B45F]/40 shadow-inner">
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#351F1D]/40 via-transparent to-transparent pointer-events-none" />
            </div>
